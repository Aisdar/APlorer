...
QT_MOC_LITERAL(1, 7, 11), // "plusClicked"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 14) // "movePlusButton"

    },
    "TabBar\0plusClicked\0\0movePlusButton"
};
...
void TabBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->plusClicked(); break;
        case 1: _t->movePlusButton(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TabBar::plusClicked)) {
                *result = 0;
                return;
            }
        }
